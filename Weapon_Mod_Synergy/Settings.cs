...
namespace Weapon_Mod_Synergy
{
    ...
    public class Settings
    {
        public Settings()
        {
            ...
            Sword = new WeaponSettings { Damage = 7, Reach = 1.0f, Speed = 1.0f, Stagger = 0.75f, Skill = WeaponSkill.OneHanded, NamedIDs = "-katana;-spear;-shortspear;-javelin;-scimitar", SearchLogic = LogicOperator.AND, KeywordIDs = "WeapTypeSword;-ShWeapTypeShortspear;-WeapTypeWhip;-WeapTypeKatana;-WeapTypeScimitar" };
            ...
            Katana = new WeaponSettings { Damage = 6, Reach = 1.0f, Speed = 1.125f, Stagger = 0.75f, Skill = WeaponSkill.OneHanded, NamedIDs = "katana", KeywordIDs = "WeapTypeKatana" };
